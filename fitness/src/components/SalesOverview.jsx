...
const API = "http://localhost:5001"; // ปรับเป็น VITE_API_URL ได้ถ้ามี
...
function SalesOverview() {
  ...
  const [summary, setSummary] = useState(null);                // ✅ NEW: dashboard summary
  const [checkinsByHour, setCheckinsByHour] = useState([]);    // ✅ NEW: for hourly chart
  ...
  useEffect(() => {
    const fetchAll = async () => {
      ...
      try {
        ...
        // เรียก 2 API พร้อมกัน: Sale ตาม filter + Dashboard summary
        ...
        // ข้อมูลสำหรับกราฟ Check-ins by hour
  ...
  // ถ้าอยากโชว์ Top Point Earners ในอนาคต: ใช้ summary.topPoints ได้เลย
  ...
  return (
    <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      {/* ✅ NEW: Check-ins by Hour (ถ้ามีข้อมูล) */}
      <Card className="col-span-2">
        <CardContent className="p-4">
